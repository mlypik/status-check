package io.github.mlypik.statuscheck.api
...
/**
  * The status-check service interface.
  * <p>
  * This describes everything that Lagom needs to know about how to serve and
  * consume the StatuscheckService.
  */
trait StatuscheckService extends Service {
  ...
  override final def descriptor = {
    ...
    named("status-check")
      ...
      .withTopics(
        topic(StatuscheckService.TOPIC_NAME, greetingsTopic)
