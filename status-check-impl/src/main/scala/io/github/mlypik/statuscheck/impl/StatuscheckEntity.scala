...
/**
  * This is an event sourced entity. It has a state, [[StatuscheckState]], which
  ...
  */
class StatuscheckEntity extends PersistentEntity {

  override type Command = StatuscheckCommand[_]
  override type Event = StatuscheckEvent
  override type State = StatuscheckState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: StatuscheckState = StatuscheckState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case StatuscheckState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        StatuscheckState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class StatuscheckState(message: String, timestamp: String)

object StatuscheckState {
  /**
    ...
    */
  implicit val format: Format[StatuscheckState] = Json.format
}

/**
  * This interface defines all the events that the StatuscheckEntity supports.
  */
sealed trait StatuscheckEvent extends AggregateEvent[StatuscheckEvent] {
  def aggregateTag = StatuscheckEvent.Tag
}

object StatuscheckEvent {
  val Tag = AggregateEventTag[StatuscheckEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends StatuscheckEvent
...
/**
  ...
  */
sealed trait StatuscheckCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends StatuscheckCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends StatuscheckCommand[String]
...
/**
  ...
  * application loader.
  */
object StatuscheckSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[StatuscheckState]
  )
}
